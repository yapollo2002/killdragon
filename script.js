...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function draw() {
        ...
        if (itemMap.has(playerPosKey)) {
            ...
            ctx.fillText(item.type, item.x * cellSize + cellSize / 2, item.y * cellSize + cellSize / 1.5);
        }
    ...
    // --- THIS IS THE FIX ---
    // Use 'touchstart' for reliable mobile controls
...
Now the on-screen controls should work perfectly on your Android phone
